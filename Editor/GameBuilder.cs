...
namespace Exanite.Building.Editor
{
    ...
    public static class GameBuilder
    {
        ...
        /// <summary>
        ///     Builds a Client and Server using the active build target and the
        ///     scenes defined in the Build Settings Unity menu
        /// </summary>
        ...
        /// <summary>
        ///     Builds a Client using the active build target and the scenes
        ///     defined in the Build Settings Unity menu
        /// </summary>
        ...
        /// <summary>
        ///     Builds a Server using the active build target and the scenes
        ///     defined in the Build Settings Unity menu
        /// </summary>
        ...
        /// <summary>
        ///     Generates and returns the current build version
        ///     <para/>
        ...
        {
            var folderName = isServer ? ServerFolderName : ClientFolderName;
            var executableName = isServer ? ServerExecutableName : ClientExecutableName;
